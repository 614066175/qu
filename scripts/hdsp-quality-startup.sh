...
exec nohup java -Xmx500m -Xms500m \
    -DSPRING_DATASOURCE_URL='jdbc:mysql://db.hdsp.hand.com:3306/hdsp_quality?useUnicode=true&characterEncoding=utf-8&useSSL=false' \
    ...
    -jar hdsp-quality.jar > ./logs/hdsp-quality.log 2>&1 &
