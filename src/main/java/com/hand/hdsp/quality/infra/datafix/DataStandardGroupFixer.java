 ...
 * @date: 2023/2/3 11:03
 */
@Component(value = "DATA_STANDARD_FIXER")
public class DataStandardGroupFixer implements GroupDataFixer {
    private final StandardGroupRepository standardGroupRepository;
    private final DataStandardRepository dataStandardRepository;
    private final CommonGroupRepository commonGroupRepository;

    public DataStandardGroupFixer(StandardGroupRepository standardGroupRepository, DataStandardRepository dataStandardRepository, CommonGroupRepository commonGroupRepository) {
    ...
    public void groupDataFix() {
        ...
        //查询所有数据标准分组
        List<StandardGroup> groups = standardGroupRepository.select(StandardGroup.builder().standardType(DATA).build());
    ...
    private void doFix(StandardGroup group, Map<Long, StandardGroup> standardGroupMap, Map<Long, Long> groupMap, Set<Long> fixedGroup) {
        ...
        CommonGroup commonGroup = CommonGroup.builder().groupType(DATA_STANDARD)
