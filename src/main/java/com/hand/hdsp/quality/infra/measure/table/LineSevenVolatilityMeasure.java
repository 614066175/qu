 ...
 */
@CheckItem("TABLE_LINE_SEVEN_VOLATILITY")
public class LineSevenVolatilityMeasure implements Measure {

    private final BatchResultBaseMapper batchResultBaseMapper;

    public LineSevenVolatilityMeasure(BatchResultBaseMapper batchResultBaseMapper) {
