 ...
 */
@CheckItem("FIELD_MIN_VOLATILITY")
public class MinVolatilityMeasure implements Measure {
    ...
    public MinVolatilityMeasure(DatasourceFeign datasourceFeign, BatchResultRuleMapper batchResultRuleMapper) {
