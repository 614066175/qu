 ...
 */
@CheckItem("FIELD_SUM_VOLATILITY")
public class SumVolatilityMeasure implements Measure {
    ...
    public SumVolatilityMeasure(DatasourceFeign datasourceFeign, BatchResultRuleMapper batchResultRuleMapper) {
