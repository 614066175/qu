 ...
 */
@CheckItem("TABLE_LINE_ONE_DIFF_VALUE")
public class LineOneDiffValueMeasure implements Measure {

    private final BatchResultBaseMapper batchResultBaseMapper;

    public LineOneDiffValueMeasure(BatchResultBaseMapper batchResultBaseMapper) {
