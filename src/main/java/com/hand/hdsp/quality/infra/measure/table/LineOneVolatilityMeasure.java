 ...
 */
@CheckItem("TABLE_LINE_ONE_VOLATILITY")
public class LineOneVolatilityMeasure implements Measure {

    private final BatchResultBaseMapper batchResultBaseMapper;

    public LineOneVolatilityMeasure(BatchResultBaseMapper batchResultBaseMapper) {
