 ...
 */
@CheckItem("FIELD_ONE_SUM_VOLATILITY")
public class OneSumVolatilityMeasure implements Measure {

    private static final String SQL = "select sum(%s) currentValue from %s";
    private final DatasourceFeign datasourceFeign;
    private final BatchResultRuleMapper batchResultRuleMapper;

    public OneSumVolatilityMeasure(DatasourceFeign datasourceFeign, BatchResultRuleMapper batchResultRuleMapper) {
