 ...
 */
@CheckItem("FIELD_MAX_VOLATILITY")
public class MaxVolatilityMeasure implements Measure {
    ...
    public MaxVolatilityMeasure(DatasourceFeign datasourceFeign, BatchResultRuleMapper batchResultRuleMapper) {
