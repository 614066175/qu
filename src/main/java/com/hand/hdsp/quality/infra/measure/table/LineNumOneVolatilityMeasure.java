 ...
 */
@CheckItem("TABLE_LINE_NUM_ONE_VOLATILITY")
public class LineNumOneVolatilityMeasure implements Measure {

    private final BatchResultBaseMapper batchResultBaseMapper;

    public LineNumOneVolatilityMeasure(BatchResultBaseMapper batchResultBaseMapper) {
