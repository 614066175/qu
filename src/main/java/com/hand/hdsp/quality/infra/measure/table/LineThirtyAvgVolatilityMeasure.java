 ...
 */
@CheckItem("TABLE_LINE_THIRTY_AVG_VOLATILITY")
public class LineThirtyAvgVolatilityMeasure implements Measure {

    private final BatchResultBaseMapper batchResultBaseMapper;

    public LineThirtyAvgVolatilityMeasure(BatchResultBaseMapper batchResultBaseMapper) {
