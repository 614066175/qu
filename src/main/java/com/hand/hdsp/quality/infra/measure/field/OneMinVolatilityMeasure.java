 ...
 */
@CheckItem("FIELD_ONE_MIN_VOLATILITY")
public class OneMinVolatilityMeasure implements Measure {

    private static final String SQL = "select min(%s) currentValue from %s";
    private final DatasourceFeign datasourceFeign;
    private final BatchResultRuleMapper batchResultRuleMapper;

    public OneMinVolatilityMeasure(DatasourceFeign datasourceFeign, BatchResultRuleMapper batchResultRuleMapper) {
