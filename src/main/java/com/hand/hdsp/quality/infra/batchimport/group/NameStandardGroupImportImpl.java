...
public class NameStandardGroupImportImpl extends AbstractCommonGroupImportImpl {
    private ObjectMapper objectMapper;


    public NameStandardGroupImportImpl(ObjectMapper objectMapper) {
    ...
    public Boolean doImport(List<String> data) {
        ...
        for (String json : data) {
            try {
                ...
                commonGroup.setGroupType(NAME_STANDARD);
