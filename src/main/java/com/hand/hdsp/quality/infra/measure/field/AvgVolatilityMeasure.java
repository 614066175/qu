 ...
 */
@CheckItem("FIELD_AVG_VOLATILITY")
public class AvgVolatilityMeasure implements Measure {
    ...
    public AvgVolatilityMeasure(DatasourceFeign datasourceFeign, BatchResultRuleMapper batchResultRuleMapper) {
