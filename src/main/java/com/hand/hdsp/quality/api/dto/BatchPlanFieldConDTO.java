...
@ApiModel("批数据方案-字段规则条件表")
@JsonInclude(JsonInclude.Include.NON_NULL)
@VersionAudit
@ModifyAudit
public class BatchPlanFieldConDTO extends AuditDomain {

    @ApiModelProperty("表ID，主键，供其他表做外键")
    private Long conditionId;

    @ApiModelProperty(value = "字段校验项ID XQUA_BATCH_PLAN_FIELD_LINE.PLAN_LINE_ID")
    @NotNull
