...
public class DataStandardGroupImportImpl extends AbstractCommonGroupImportImpl {
    private ObjectMapper objectMapper;


    public DataStandardGroupImportImpl(ObjectMapper objectMapper) {
    ...
    public Boolean doImport(List<String> data) {
        ...
        for (String json : data) {
            try {
                ...
                commonGroup.setGroupType(DATA_STANDARD);
